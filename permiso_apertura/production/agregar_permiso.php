          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Agregar Apertura de Cuenta <small> Fichosa</small></h3>
              </div>
            </div>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form action="crear_permiso.php" method="post" class="form-horizontal form-label-left" novalidate>
                      <input type="hidden" name="id_use" value="<?php echo "$user_id"; ?>">
                      ...
                      <div class="field form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" data-validate-length-range="13,13" id="identidad" name="identidad" required="required" class="form-control col-md-7 col-xs-12" pattern="alphanumeric" value="" onkeypress='return valida(event)'>
                        </div>
                      ...
                      <div class="field form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="pnombre" name="pnombre" required="required" class="form-control col-md-7 col-xs-12" value="" onkeypress='return val(event)'>
                        </div>
                      </div>
                      ...
                      <div class="field form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="tel" class='tel form-control col-md-7 col-xs-12' name="telefono"  data-validate-length-range="8,8" value="">
                        </div>
                      </div>
                      ...
                      <div class="field form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="departamento" name="departamento" class="form-control col-md-7 col-xs-12" value="" onkeypress='return val(event)'>
                        </div>
                      </div>

                      <div class="field form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="tipo_beca">Tipo_beca <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <?php
                            $sql_gen="SELECT id_tipo_beca, tipo_beca FROM tipo_beca"; 
                            $result_gen = mysqli_query ($con, $sql_gen);
                              echo "<select name='tipo_beca' id='tipo_beca' required='required' class='form-control col-md-7 col-xs-12'>";
                              echo "<option disabled selected value>....Seleccione....</option>";
                              while($registro=mysqli_fetch_row($result_gen))
                              {
                                echo "<option value='".utf8_encode($registro[0])."'>".utf8_encode($registro[1])."</option>";
                              }
                            echo "</select>";
                          ?>
                        </div>
  ...
  if ($launch==1)
  {
    ?>
      <script>
        $.alert({
          title: 'Sibecs',
          content: 'Este numero de identidad ya esta registrado',
      });
      </script>
      <?php
  }
  if ($launch==2)
  {
    ?>
      <script>
        $.alert({
          title: 'Sibecs',
          content: 'Error al Guardar Permiso',
      });
      </script>
      <?php
  }
  if ($launch==3)
  {
    ?>
      <script>
        $.alert({
          title: 'Sibecs',
          content: 'Permiso guardado correctamente',
      });
      </script>
      <?php
  }
