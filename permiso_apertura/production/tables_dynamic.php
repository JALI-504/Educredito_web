          ...
          <div class="">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                          ...
                          while($row = mysqli_fetch_array($stdi_centr))
                          {
                            ...
                            ?>
                              <tr>
                                ...
                                <td><?php echo "$link"; ?></td>
                                <td><a href="autorizacion.php?idbeca=<?php echo "$nbeca"; ?>" title="" target="_blank" style="color:green; font-weight: bold;">Imprimir</a>
                                  &nbsp;&nbsp;&nbsp;&nbsp;<a href="modificar_permiso.php?idbeca=<?php echo "$nbeca"; ?>" title="">Modificar</a></td>
                              </tr>
                            <?php
                          } 
                        ?>
                  ...
                  <a class="btn btn-success" href="agregar_permiso.php" title="">Agregar Constancia</a>
                </div>
              </div>
            </div>
          </div>
