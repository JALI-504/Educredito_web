<?php 
  ...
  $sql_centr="SELECT id_permiso ID, identidad IDENT, nombre NOMBR, telefono TEL, ciudad CIUD, link LINK FROM permiso";
  $stdi_centr=mysqli_query ($con, $sql_centr);

  $usuario_act=$_SESSION['usuarioactual'];
  $sql_user="SELECT pnombre USER, papellido APELL FROM usuarios WHERE usuario='$usuario_act'";
