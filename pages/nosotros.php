...
<body>
		...
		<nav>
			<div id="mencenter">
				...
				<ul>
					...
					<li><a href="onadici.php"><span class="icon-point-right"></span>Control Interno</a></li>
	...
	<div class="wrapper">
		...
		<section id="cont_med">
			...
			<p>El Instituto de Crédito Educativo EDUCREDITO es un organismo autónomo del Estado, creado con la finalidad de proporcionar financiamiento a las personas hondureñas que desean realizar estudios dentro o fuera del territorio nacional, fundamentalmente en programas educativos que garanticen una adecuada formación profesional, en los campos de la ciencia y la técnica que en materia de recursos humanos demanda el país.</p>
			<div id="img_edu_2">
				<img src="../images/educ.jpg" alt="">
			</div>
		</section>
