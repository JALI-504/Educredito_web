		...
		<nav>
			<div id="mencenter">
				...
				<ul>
					...
					<li><a href="pages/onadici.php"><span class="icon-point-right"></span>Contol Interno</a></li>
	...
	<div class="wrapper">
		<section id="portada">
			<div id="bienvenida">
				...
				<div id="img_edu">
					<img src="images/logo_educ.png" img style="margin-left: 120px" alt="">
				</div>
			</div>
		</section>
		<article id="intituciones">
			<div id="info_instit">
				<a href="https://portalunico.iaip.gob.hn/#/portal=409" target="_blank" title="Instituto de Acceso a la Información Pública"><img id="img_iap" src="images/iap2.png" alt=""></a>
		...
		<section id="cont_med">
			...
			<p>La Presidenta Iris Xiomara Castro Sarmiento y EDUCRÉDITO se preocupan por tus estudios y capacitación, a través del Crédito Educativo, cubrimos total o parcialmente los costos académicos de diversos programas en los niveles de:</p>
			<div id="col1">
				<ul>
